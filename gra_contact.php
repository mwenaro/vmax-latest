...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->addAddress('info@graeslilias.co.ke'); // Add a recipient1
        $mail->addAddress('sales@graeslilias.co.ke'); // Add a recipient2
        $mail->addAddress('mweroabdalla@gmail.com'); // Add a recipient2
